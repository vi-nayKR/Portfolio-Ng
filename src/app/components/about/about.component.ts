        ...
        <div class="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div [class.animate-slide-in-left]="visible()" [style.opacity]="visible() ? '1' : '0'" style="transition: opacity 0.7s">
            ...
            <p class="text-muted leading-relaxed mb-4">
              I have nearly three years of professional engineering experience across fintech (<span class="text-frost">Liminal Custody</span>) and regulated gaming (<span class="text-frost">Light &amp; Wonder</span>), building production backend infrastructure, ML recommendation pipelines, and automated compliance engines.
            </p>
            <p class="text-muted leading-relaxed mb-4">
...
export class AboutComponent implements OnInit {
  ...
  cards = [
    ...
    },
    {
      ...
      desc: 'Production backend services, atomic transactional workflows, Redis caching, and OpenTelemetry observability',
    },
  ];
