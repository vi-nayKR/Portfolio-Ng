  ...
  experiences = [
    {
      ...
      type: 'Full-time',
      highlights: [
        'Architected automated policy verification and compliance audit workflows using TypeScript, Node.js, and Redis semantic caching, reducing manual custody approvals.',
        ...
        'Implemented organization-scoped RBAC, step-up authentication, and OpenTelemetry distributed tracing across async custody microservices, ensuring full enterprise auditability.',
      ],
      tags: ['TypeScript', 'Node.js', 'Redis Caching', 'FastAPI', 'RBAC', 'OpenTelemetry', 'PostgreSQL', 'Angular'],
    ...
    },
    {
      ...
      tags: ['C# / .NET Core', 'ML Recommendation', 'RxJS', 'WebSockets', 'SQL Server', 'Cypress', 'Telemetry'],
    ...
    },
    {
      ...
      tags: ['Collaborative Filtering', 'ML Algorithms', 'C# / .NET Core', 'Angular', 'REST APIs'],
      image: 'roulette.png',
      aspect: 'aspect-[4/3]',
      maxWidth: 'max-w-[320px]',
    },
